...
public class ExportExcelUtils {
	...
	public void exportData(){
		try {
			...
			//  让列宽随着导出的列长自动适应
			 ...
			 sheet.autoSizeColumn((short)9); //调整第十列宽度
			 sheet.autoSizeColumn((short)10); //调整第十一列宽度
			 sheet.autoSizeColumn((short)11); //调整第十二列宽度
			 sheet.autoSizeColumn((short)12); //调整第十三列宽度
			 sheet.autoSizeColumn((short)13); //调整第十四列宽度
			 sheet.autoSizeColumn((short)14); //调整第十五列宽度
			 sheet.autoSizeColumn((short)15); //调整第十六列宽度
	...
	public HSSFCellStyle getColumnTopStyle(HSSFWorkbook workbook) {  
        ...
        //字体加粗  
       // font.setBoldweight(HSSFFont.b.BOLDWEIGHT_BOLD);  
        //设置字体名字   
