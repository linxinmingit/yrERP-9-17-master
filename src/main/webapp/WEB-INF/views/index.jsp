		...
		<div class="layui-main mag0 layui-icon">
			...
			<ul class="layui-nav top_menu">
				...
				<li class="layui-nav-item" id="userInfo">
					<a href="javascript:;"><img src="images/face.jpg" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">${sessionScope.user.getName()}</cite></a>
					<dl class="layui-nav-child">
		...
		<div class="navBar layui-side-scroll" id="navBar">
			<ul class="layui-nav layui-nav-tree">
				<li class="layui-nav-item layui-this">
					<a href="javascript:;" data-url="main"><i class="layui-icon" data-icon=""></i><cite>sfsd后台首页</cite></a>
				</li>
			</ul>
		</div>
	</div>
